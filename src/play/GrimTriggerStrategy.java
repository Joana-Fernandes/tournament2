...
public class GrimTriggerStrategy  extends Strategy {
    ...
    public void execute() throws InterruptedException {
        ...
        while(true) {
            ...
            while(! playComplete ) {
                ...
                game.showGame();
                double[] strategyP1 = setGrimmTriggerStrat(1,labelsP1,myStrategy, myLastMoveAsP1, oppLastMoveAsP2); // Aqui faz as strats 1
                double[] strategyP2 = setGrimmTriggerStrat(2,labelsP2,myStrategy, myLastMoveAsP2,oppLastMoveAsP1); // Aqui faz as strats 2
    ...
    public double[] setGrimmTriggerStrat(int P, String[] labels, PlayStrategy myStrategy, GameNode myLastMove, GameNode oppLastMove) {
        int n = labels.length;
        double[] strategy = new double[n];

        if(myLastMove != null && (showLabel(myLastMove.getLabel()).equals("Defect") || showLabel(oppLastMove.getLabel()).equals("Defect")) || myStrategy.probabilityForNextIteration() <= 1f/3f) {
            for(int i = 0; i<n; i++){
